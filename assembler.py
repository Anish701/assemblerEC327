...
#library which matches command to binary
...
#converts commands/instructions to binary
def binCom(com):
...
#handles commands with 1 or 2 parameters (except mov and jump commands)
...
#determines which mov command user has selected based on parameters
...
#str stores the total machine code in hexadecimal
str = str + x

#keep asking for code until user inputs halt (hexadecimal = 0000)
while x != '0000':
    x = ask()
    print('Hexadecimal: 0x' + x)
    print()
